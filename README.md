...
Usuario abre la aplicación → redirigido a Login
Ingresa email y contraseña
Backend valida credenciales y retorna JWT token
Frontend guarda token y datos del usuario
Contexto de autenticación actualiza estado
Usuario redirigido al dashboard según rol
